    ...
    def on_hover(self, view, point, hover_zone):
        if hover_zone == sublime.HOVER_TEXT:
            if view.id() in UrlHighlighter.urls_for_view:
                ...
                url = view.substr(pt)
                view.show_popup(
                    '<style>body{margin: 0}div{border: 1px; border-style: solid; border-color: grey; }</style>'
                    '<body><div><a href="open"><img width="20%" height="20%" src="res://Packages/ClickableUrls/link.png"/></a></div></body>',
